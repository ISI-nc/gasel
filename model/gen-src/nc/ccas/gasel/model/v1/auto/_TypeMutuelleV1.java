...
import nc.ccas.gasel.model.v1.MutuelleV1;

/** Class _TypeMutuelleV1 was generated by Cayenne.
  * It is probably a good idea to avoid changing this class manually, 
  * since it may be overwritten next time code is regenerated. 
  * If you need to make any customizations, please use subclass. 
  */
public abstract class _TypeMutuelleV1 extends org.apache.cayenne.CayenneDataObject {

    /**
	 * 
	 */
	private static final long serialVersionUID = -5980482549951594464L;
    ...
    public static final String T_MUTUELLE_ARRAY_PROPERTY = "tMutuelleArray";
    ...
    public void addToTMutuelleArray(nc.ccas.gasel.model.v1.MutuelleV1 obj) {
        addToManyTarget("tMutuelleArray", obj, true);
    }
    public void removeFromTMutuelleArray(nc.ccas.gasel.model.v1.MutuelleV1 obj) {
        removeToManyTarget("tMutuelleArray", obj, true);
    }
    @SuppressWarnings("unchecked")
    public List<nc.ccas.gasel.model.v1.MutuelleV1> getTMutuelleArray() {
        return (List<MutuelleV1>)readProperty("tMutuelleArray");
    }
